...
public static final Function<Item, CapabilityItem.Builder> KATANA = (item) -> {
        CapabilityItem.Builder builder = WeaponCapability.builder()
            ...
            .newStyleCombo(Styles.TWO_HAND, ROSAnimations.KATANA_AUTO1, Animations.UCHIGATANA_AUTO2, Animations.UCHIGATANA_AUTO3, Animations.UCHIGATANA_DASH, Animations.UCHIGATANA_AIR_SLASH)
